...
class controller_shop {
    ...
    function getAllMovies(){
        $json = loadModel(CLIENT_SHOP_MODEL, "shop_model", "getAllMovies");
    ...
    function getAllMoviesByGenres(){
        $json = loadModel(CLIENT_SHOP_MODEL, "shop_model", "getAllMoviesByGenres",$_GET["param"]);
        echo json_encode($json); 
    }
