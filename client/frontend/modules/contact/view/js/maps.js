var map;
      ...
      function initMap() {
        ...
        var ontinyent = {lat: 38.821277, lng:  -0.606740};
        var map = new google.maps.Map(
            document.getElementById('map'), {
              ...
              disableDoubleClickZoom: true, // this is for disable Double Click Zoom
              draggableCursor:'cursor',// this is for cursor type
        ...
        var marker = new google.maps.Marker({position: ontinyent, map: map});
      }